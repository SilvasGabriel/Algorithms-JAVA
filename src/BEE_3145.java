...
public class BEE_3145 {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            int distanceVilaToLonely = scanner.nextInt();

            double numberOfDays = (double)distanceVilaToLonely / (double)(numberOfDwarfs + 2);

            System.out.println(twoHouse.format(numberOfDays));
