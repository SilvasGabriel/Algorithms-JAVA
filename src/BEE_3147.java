...
public class BEE_3147 {
    ...
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)){
           ...
           int dwarves = scanner.nextInt();
           int orcs = scanner.nextInt();
           int wargs = scanner.nextInt();
           int eagles = scanner.nextInt();

           int armyGOOD = humans + elves + dwarves + eagles;
           int armyBAD = orcs + wargs;
