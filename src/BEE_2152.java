 ...
 * One day, the great hero Chapolout helped a scientist who has created many inventions. One of these inventions is a system that opens the door secret laboratory.
 * The system consists of removing a side door of the candlestick candle, that it opens, and to put the candle back to the chandelier, the door closes. 
 * But Chapolout found that the sail was just a pretend. In fact, the scientist assistant, called Pepe, that opened the lab door, inside. A while later, the system was modified to also run the initial project. 
 ...
 *      3                   15:30 - A porta abriu!
 *      15 30 1             23:50 - A porta fechou!
 *      23 50 0             00:05 - A porta abriu!
 *      0 5 1
 * 
 */
public class BEE_2152 {
    public static void main(String[] args) {
        try (Scanner read = new Scanner(System.in)) {
            ...
            DecimalFormat twovalues = new DecimalFormat("00");
            ...
            for (int i = 0; i < numberOfTests; i++) {
                ...
                if(door == 1){
                    System.out.println(twovalues.format(hour) + ":" + twovalues.format(minutes) +" - A porta abriu!");
                }

                if(door == 0){
                    System.out.println(twovalues.format(hour) + ":" + twovalues.format(minutes) + " - A porta fechou!");
                }
            }
