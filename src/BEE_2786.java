...
public class BEE_2786 {
    ...
    public static void main(String[] args) {
        try (Scanner read = new Scanner(System.in)) {
            ...
            int typeOneTile = (row * column) + ((row - 1) * (column - 1));
            int typeTwoTile = ((row - 1) * 2) + ((column - 1) * 2);

            System.out.println(typeOneTile);
            System.out.println(typeTwoTile);
